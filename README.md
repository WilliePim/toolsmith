...
The project follows a tutorial on building a self-extending agent whose second half was
behind a paywall. *Reference: (placeholder — to be filled in).* Nothing from it is
reproduced here: no text, figures or tables — only a description, in my own words, of
which ideas came from the readable half.
